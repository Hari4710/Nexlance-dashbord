...
export default function Home() {
  ...
  // ALL COLOURS GRADIENT INCLUDING RED
  const fullGradient = "linear-gradient(90deg, #FF0000 0%, #FFD60A 16%, #00D9FF 33%, #3B82F6 50%, #8B5CF6 66%, #EC4899 83%, #FF8C42 100%)";

  return (
    <div className="min-h-screen bg-[#eef1f6] flex font-sans">
      <style>{`
        @keyframes logoGlow {
          0%, 100% { box-shadow: 0 0 12px rgba(255,0,0,0.5), 0 0 20px rgba(255,214,10,0.5), 0 0 30px rgba(59,130,246,0.4); }
          50% { box-shadow: 0 0 20px rgba(255,140,66,0.9), 0 0 35px rgba(236,72,153,0.7), 0 0 45px rgba(0,217,255,0.5); }
        }
        @keyframes logoFloat {
     ...
     .animated-logo { animation: logoGlow 2.5s ease-in-out infinite, logoFloat 3s ease-in-out infinite; }
      ...
      <aside className="w-[280px] bg-[#0f172a] text-slate-400 flex flex-col shrink-0">
        {/* LOGO - FIXED FAT ISSUE - SQUARE + ALL COLOURS GLOW */}
        <div className="p-4 border-b border-white/10 flex gap-3 items-center">
          <div className="relative w-[48px] h-[48px] min-w-[48px] max-w-[48px] aspect-square bg-black rounded-2xl flex items-center justify-center overflow-hidden ring-1 ring-white/20 animated-logo shrink-0">
            <div className="absolute inset-0 opacity-30 animate-pulse rounded-2xl" style={{ background: fullGradient }}></div>
            <img src="/logo.png" alt="Nexlance" className="w-[32px] h-[32px] min-w-[32px] min-h-[32px] object-contain relative z-10" />
          </div>
          <div className="flex-1">
            <div className="flex gap-2 items-start">
              <p className="text-white text-[13px] font-bold leading-[15px]">Nexlance Collections<br />System</p>
              <span className="bg-[#0ea5e9] text-white text-[7px] px-1.5 py-0.5 rounded leading-[8px] font-bold">v1.0<br />System<br />of<br />Record</span>
            </div>
          </div>
        </div>
          ...
          {menu.map((m) => {
            ...
            return (
              <div
                ...
                ${sel? "text-[#1a1033] font-bold shadow-[0_6px_24px_rgba(236,72,153,0.6)] scale-[1.02]" : "hover:bg-white/10 text-slate-400 hover:text-white bg-white/[0.04]"}`}
                style={sel? { background: fullGradient } : {}}
              >
        ...
        <div className="p-3 border-t border-white/10">
          <button onClick={doLogout} className="w-full py-3 rounded-full text-[12px] font-bold shadow-lg text-[#1a1033]" style={{ background: fullGradient }}>Logout →</button>
        </div>
      </aside>
      ...
      <main className="flex-1 min-w-0">
        <div className="h-[72px] bg-[#0f172a] flex items-center gap-2 px-3 relative z-[300] border-b border-white/10">
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="bg-[#1e293b] border border-white/10 px-2 py-1.5 rounded-full flex items-center gap-2"><div className="w-7 h-7 rounded-full flex items-center justify-center text-[#1a1033] text-[10px] font-bold" style={{ background: fullGradient }}>K</div><div><p className="text-white text-[10px] font-bold leading-3">Karthick<br />Founder</p><p className="text-[7px] text-slate-400">karthick@nexlance.in</p></div><span className="bg-[#a855f7]/20 text-[#d8b4fe] text-[7px] px-1.5 py-0.5 rounded-full">Founder</span></div>
