...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#eef1f6] flex font-sans">
      <style>{`
        @keyframes logoGlow {
          0%, 100% { box-shadow: 0 0 12px rgba(255,196,0,0.6), 0 0 20px rgba(59,130,246,0.4), 0 0 30px rgba(139,92,246,0.3); }
          50% { box-shadow: 0 0 20px rgba(255,140,66,0.9), 0 0 35px rgba(139,92,246,0.6), 0 0 45px rgba(59,130,246,0.5); }
        }
        @keyframes logoFloat {
      ...
      <aside className="w-[280px] bg-[#0f172a] text-slate-400 flex flex-col shrink-0">
        {/* HEADER - LOGO FIXED - NO FAT */}
        <div className="p-4 border-b border-white/10 flex gap-3 items-center">
          <div className="relative w-[48px] h-[48px] min-w-[48px] aspect-square bg-black rounded-2xl flex items-center justify-center overflow-hidden ring-1 ring-white/20 animated-logo">
            <div className="absolute inset-0 bg-gradient-to-br from-[#FFC400] via-[#3B82F6] via-[#8B5CF6] to-[#FF8C42] opacity-30 animate-pulse rounded-2xl"></div>
            <img src="/logo.png" alt="Nexlance" className="w-[32px] h-[32px] object-contain relative z-10" />
          </div>
          ...
          {menu.map((m) => {
            ...
            return (
              <div
                ...
                ${sel
               ? "bg-gradient-to-r from-[#FFC400] via-[#60A5FA] via-[#A78BFA] to-[#FB923C] text-[#1a1033] font-bold shadow-[0_6px_24px_rgba(251,146,60,0.6)] scale-[1.02]"
                  : "hover:bg-white/10 text-slate-400 hover:text-white bg-white/[0.04]"}`}
              >
        ...
        <div className="p-3 border-t border-white/10">
          <button onClick={doLogout} className="w-full bg-gradient-to-r from-[#FFC400] via-[#3B82F6] to-[#FF8C42] text-[#1a1033] py-3 rounded-full text-[12px] font-bold shadow-lg">Logout →</button>
        </div>
      </aside>
      ...
      <main className="flex-1 min-w-0">
        <div className="h-[72px] bg-[#0f172a] flex items-center gap-2 px-3 relative z-[300] border-b border-white/10">
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="bg-[#1e293b] border border-white/10 px-2 py-1.5 rounded-full flex items-center gap-2"><div className="w-7 h-7 bg-gradient-to-r from-[#FFC400] to-[#FF8C42] rounded-full flex items-center justify-center text-[#1a1033] text-[10px] font-bold">K</div><div><p className="text-white text-[10px] font-bold leading-3">Karthick<br />Founder</p><p className="text-[7px] text-slate-400">karthick@nexlance.in</p></div><span className="bg-[#a855f7]/20 text-[#d8b4fe] text-[7px] px-1.5 py-0.5 rounded-full">Founder</span></div>
